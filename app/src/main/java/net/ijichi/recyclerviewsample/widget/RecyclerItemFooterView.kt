 ...
 */
class RecyclerItemFooterView constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr){
  private val textView: TextView

  init {
    val rootView = LayoutInflater.from(context).inflate(R.layout.recycler_item_footer_view, this)
    textView = rootView.findViewById(R.id.recyclerItemFooterText)
    setOnClickListener {
      // クリック処理
    }
  }
